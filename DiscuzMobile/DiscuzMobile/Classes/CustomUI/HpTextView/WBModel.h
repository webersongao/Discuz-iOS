...
@property (nonatomic, copy) NSString *pageID; ///< 对应着 WBPageInfo
...
@property (nonatomic, copy) NSString *groupID; ///< 例如 com.sina.default
@property (nonatomic, assign) NSInteger version;
@property (nonatomic, copy) NSString *nameCN; ///< 例如 浪小花
