...
@interface DZPostTypeSelectView() <UITableViewDelegate, UITableViewDataSource>
...
@implementation DZPostTypeSelectView
...
- (void)commitInit {
    ...
    self.selectTableView = [[DZBaseTableView alloc] initWithFrame:CGRectMake(10, 10, 10, 10) style:UITableViewStylePlain];
