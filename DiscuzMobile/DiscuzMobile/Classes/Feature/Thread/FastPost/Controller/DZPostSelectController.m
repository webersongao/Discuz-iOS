...
-(void)configPostSelectController{
    ...
    self.leftTable.frame = CGRectMake(0, 0, KScreenWidth *0.22, KScreenHeight - KTabbar_Height);
    self.tableView.frame = CGRectMake(0, 0, KScreenWidth *0.78, KScreenHeight - KTabbar_Height);
