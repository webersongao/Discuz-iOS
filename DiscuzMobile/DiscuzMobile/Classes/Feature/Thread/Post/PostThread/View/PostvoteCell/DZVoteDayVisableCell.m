...
@implementation DZVoteDayVisableCell
...
- (void)p_setupViews {
    ...
    self.selectNumTextField.font = KFont(15);
    ...
    self.dayNumTextField.font = KFont(15);
    ...
    self.checkBox.titleLabel.font = KFont(16);
    ...
    self.checkBox1.titleLabel.font = KFont(16);
