...
- (void)setupViews {
    ...
    _codeView = [[DZAuthCodeView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_authCodeField.frame) + 15, CGRectGetMinY(_authCodeField.frame), 100, 40)];
    ...
    CGSize textSize = [tips.text sizeWithFont:KFont(12) maxSize:CGSizeMake(KScreenWidth - 16, CGFLOAT_MAX)];
