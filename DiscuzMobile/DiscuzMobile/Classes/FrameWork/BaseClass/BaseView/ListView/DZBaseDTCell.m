...
#import "DZBaseDTCell.h"
//#import "DTWebVideoView.h"
#import <MediaPlayer/MediaPlayer.h>

@interface DZBaseDTCell() <DTAttributedTextContentViewDelegate,DTLazyImageViewDelegate>
@end

@implementation DZBaseDTCell {
...
- (void)setHTMLString:(NSString *)html options:(NSDictionary*) options {
    ...
    [muString addAttribute:NSFontAttributeName value:KFont(15) range:allRange];
