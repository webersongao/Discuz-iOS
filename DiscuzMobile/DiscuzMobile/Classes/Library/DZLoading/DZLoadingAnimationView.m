...
@interface DZLoadingAnimationView ()
{
...
@implementation DZLoadingAnimationView



+(DZLoadingAnimationView *)sharedView
{
    static DZLoadingAnimationView *tmpLoading = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        tmpLoading = [[DZLoadingAnimationView alloc] initWithLoadingType:PRLoadingViewNoramlType];
    });
    return tmpLoading;
}
