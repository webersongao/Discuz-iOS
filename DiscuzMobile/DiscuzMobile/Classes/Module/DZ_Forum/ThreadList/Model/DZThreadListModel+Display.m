...
+ (void)setThreadData:(id)responseObject andFid:(NSString *)fid andPage:(NSInteger)page handle:(void (^)(NSArray *topArr, NSArray *commonArr, NSArray *allArr, NSInteger notFourmCount))handle {
    ...
    if ([DataCheck isValidArray:data]) {
        for (NSDictionary * dic in data) {
            ...
            DZThreadListModel *listModel = [DZThreadListModel dealGetSingleModel:dic
                                                                     andPage:page
                                                                    andGroup:gropDic
                                                                     andType:typeDic];
...
/**
 ...
 @return 帖子model
 */
+ (DZThreadListModel *)dealGetSingleModel:(NSDictionary *)dic andPage:(NSInteger)page andGroup:(NSDictionary *)groupDic andType:(NSDictionary *)typeDic {
    
//    DZThreadListModel *listModel = [[DZThreadListModel alloc] init];
//    [listModel setValuesForKeysWithDictionary:dic];
    DZThreadListModel *listModel = [DZThreadListModel modelWithJSON:dic];
