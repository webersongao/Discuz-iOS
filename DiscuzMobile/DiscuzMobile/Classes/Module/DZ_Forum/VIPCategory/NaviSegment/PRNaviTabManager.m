...
-(NSDictionary *)calculateTitleWidthinfo:(NSMutableArray *)TitleArray completion:(void(^)(NSDictionary *widthDict))completion{
    ...
    for (int index = 0; index<tempArray.count; index++) {
        ...
        if (titleStr.length) {
            if ([titleStr hasPrefix:kStoreIconPrefix]) {
                ...
                CGFloat NameWidth = [titleStr customStringWidthWithFontSize:15.0 maxHeight:16.0];
