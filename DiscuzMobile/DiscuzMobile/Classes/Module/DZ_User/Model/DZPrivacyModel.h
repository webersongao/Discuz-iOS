...
@interface DZUserFeedModel : NSObject
...
@interface DZUserViewModel : NSObject
//"view": {
//       "index": "0",
//       "friend": "0",
//       "wall": "0",
...
@interface DZPrivacyModel : NSObject
...
@property (nonatomic, strong) DZUserFeedModel *feed;  //!< 属性注释
@property (nonatomic, strong) DZUserViewModel *view;  //!< 属性注释
