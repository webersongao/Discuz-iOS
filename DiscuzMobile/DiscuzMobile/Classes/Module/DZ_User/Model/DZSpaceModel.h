...
@interface DZSpaceModel : NSObject
...
@property (nonatomic, strong) DZPrivacyModel *privacy;  //!< 属性注释
...
@property (nonatomic, strong) DZAdmingroupModel *admingroup;  //!< 属性注释
@property (nonatomic, strong) DZUserGroupModel *group;  //!< 属性注释
