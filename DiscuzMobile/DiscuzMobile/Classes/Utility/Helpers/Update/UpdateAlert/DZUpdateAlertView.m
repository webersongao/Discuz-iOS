...
- (void)_setupUI
{
    ...
    updateIcon.image = [UIImage imageNamed:@"DZVersionUpdate_Icon"];
    ...
    [cancelButton setImage:[[UIImage imageNamed:@"DZVersionUpdate_Cancel"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
